...
class BasketAPIManager {
    ...
    func callWH<T>(router: BasketRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
    ...
    func call<T>(router: BasketRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
    ...
    func call(router: BasketRouter, handler: @escaping([EventItem]?, Error?) -> Void) {
    ...
    func callResponse(router: BasketRouter, handler: @escaping(String?, SkyErrorModel?) -> Void){
