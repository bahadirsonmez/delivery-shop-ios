...
//            }
    ...
    func callWH<T>(router: WhislistRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
    ...
    func call<T>(router: WhislistRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
//        let accessToken = Account.sharedAccount.accessToken
//        let refreshToken = Account.sharedAccount.refreshToken
...
//                                                    credential: credential)
    ...
    func callResponse(router: WhislistRouter, handler: @escaping(String?, SkyErrorModel?) -> Void){
