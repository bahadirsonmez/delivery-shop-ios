...
class CreditCardFormSection: BaseCell, SetupCodeView {

    lazy var collectionView = CreditCardFormView()
...
//    ]
    ...
    @IBInspectable
    public var defaultCardColor = Constants.Colors.mainTextColor {
        didSet {
    ...
    @IBInspectable
    public var cardHolderExpireDateTextColor = UIColor.white {
        didSet {
    ...
    @IBInspectable
    public var backLineColor: UIColor = .gray {
        didSet {
    ...
    public var cardNumberFont: UIFont = Constants.Fonts.semibold24
    public var cardPlaceholdersFont: UIFont = Constants.Fonts.light14
    public var cardTextFont: UIFont = Constants.Fonts.light14
...
//        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[view(==30)]", options: NSLayoutConstraint.FormatOptions(rawValue: 0), metrics: nil, views: ["view": cardNumber]));
    ...
    private func createAmexCVC() {
        ...
        amexCVC.font = Constants.Fonts.regular13
