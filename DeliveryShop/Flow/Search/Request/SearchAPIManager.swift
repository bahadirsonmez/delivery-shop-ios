...
class SearchAPIManager {
    ...
    func callWH<T>(router: SearchRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
    ...
    func call<T>(router: SearchRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
    ...
    func call(router: SearchRouter, handler: @escaping([EventItem]?, Error?) -> Void) {
    ...
    func callResponse(router: SearchRouter, handler: @escaping(String?, SkyErrorModel?) -> Void){
