...
class CampaignsAPIManager {
    ...
    func callWH<T>(router: CampaignsRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
    ...
    func call<T>(router: CampaignsRouter, handler: @escaping (Swift.Result<T, APIError>) -> Void) where T: Codable {
    ...
    func call(router: CampaignsRouter, handler: @escaping([EventItem]?, Error?) -> Void) {
    ...
    func callResponse(router: CampaignsRouter, handler: @escaping(String?, SkyErrorModel?) -> Void){
