...
class CampaignsView: UIView {
        
    var safeArea = UILayoutGuide()
    let minLineSpacing = Constants.BasicCell.minLineSpacing
    let cellHeight = Constants.BasicCell.campaignCellHeight
...
extension CampaignsView : SetupCodeView {
...
extension CampaignsView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
